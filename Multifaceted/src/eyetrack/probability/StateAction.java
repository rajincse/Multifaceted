...
public class StateAction {
	...
	public static int ACTION_STAR_RATING_CONNECTED =4;
	public static int ACTION_STAR_RATING_DISCONNECTED =5;
	public static int ACTION_DIRECTOR_CONNECTED =6;
	public static int ACTION_DIRECTOR_DISCONNECTED =7;
	public static int ACTION_GENRE_CONNECTED =8;
	public static int ACTION_GENRE_DISCONNECTED =9;
	public static int ACTION_ACTOR_SELF=10;
	public static int ACTION_ACTOR_SAME_GROUP=11;
	public static int ACTION_ACTOR_OTHER=12;
	public static int ACTION_MOVIE_SELF=13;
	public static int ACTION_MOVIE_SAME_GROUP=14;
	public static int ACTION_MOVIE_OTHER=15;
	public static int ACTION_DIRECTOR_SELF=16;
	public static int ACTION_DIRECTOR_SAME_GROUP=17;
	public static int ACTION_DIRECTOR_OTHER=18;
	public static int ACTION_GENRE_SELF=19;
	public static int ACTION_GENRE_SAME_GROUP=20;
	public static int ACTION_GENRE_OTHER=21;
